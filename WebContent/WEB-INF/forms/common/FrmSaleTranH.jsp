...
<body>
	<h1 style="text-align: center;">出货单列表</h1>
	<hr>
	<div>
		<h4>查询条件</h4>
		<form action="FrmSale" method="post">
			...
			<div style="float:left;width: 40%;">
				客户或建档人<input type="text" name="searchText" value="${searchText}"><br>
		...
		<tbody>
			...
			<c:forEach items="${dataSet}" var="item">
				<tr align=center>
					...
					<td><a href="FrmSale.ShowTranB?tbNo=${item.items.TBNo_}">${item.items.TBNo_}</a></td>
					<td>${item.items.TBDate_}</td>
					<td>${item.items.CusName_}</td>
