...
<body>
	<h1 style="text-align: center;">进货单列表</h1>
	<hr>
	<div>
		<h4>查询条件</h4>
		<form action="FrmPurchase" method="post">
			...
			<div style="float:left;width: 40%;">
				厂商或建档人<input type="text" name="searchText" value="${searchText}"><br>
		...
		<tbody>
			...
			<c:forEach items="${dataSet}" var="item">
				<tr align=center>
					...
					<td><a href="FrmPurchase.ShowTranB?tbNo=${item.items.TBNo_}">${item.items.TBNo_}</a></td>
					<td>${item.items.TBDate_}</td>
					<td>${item.items.SupName_}</td>
	...
	<div align="left">
		<a href="FrmPurchase.addTranH">新增</a>
